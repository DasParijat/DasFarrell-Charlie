...
/**
 * Tests behavior when the dealer up-card has an invalid rank.
 */
public class TestInvalidUpCardRank extends TestCase {
    public void test() {
        ...
        Card upCard = new Card(0, Card.Suit.SPADES); // invalid rank
